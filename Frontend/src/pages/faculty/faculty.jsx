    ...
    async function GetDetails() {
        try {
        const response = await axios.get("http://localhost:5000/faculty/requests");
    ...
    return (
        ...
        <div className="pt-20 px-4 pb-6">
            ...
            <div className="w-full min-h-[calc(100vh-64px)] flex flex-col items-center lg:justify-center">
                {/* Simplified centering logic using Tailwind */}
                ...
                ({ student_name, student_email, language_name, level, request_id }, id) => (
                    ...
                    <div className="flex flex-row">
                        ...
                        <p
                            ...
                            onClick={() => {
                            localStorage.setItem("mentor_review", student_name);
                    ...
                    <div className="flex mt-4 gap-2">
                        <button
                        className="flex-1 bg-green-600 hover:bg-green-700 text-white py-1 rounded-sm hover:cursor-pointer"
                        onClick={() => HandleApprove(request_id)}
                        >
                        Approve
                        </button>
                        <button
                        className="flex-1 bg-red-600 hover:bg-red-700 text-white py-1 rounded-sm hover:cursor-pointer"
                        onClick={() => {
                            HandlePopUp(student_name, student_email, language_name, level);
                            setFeedBack("");
                        }}
                        >
                        Reject
