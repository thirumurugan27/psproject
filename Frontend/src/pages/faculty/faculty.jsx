...
function Faculty() {
    ...
    async function GetAvgStar(email, language) {
        try {
            ...
            console.log(`mentor avg star for ${email}-${language}: `, response.data);
            setAvgStars((prev) => ({
                ...prev,
                                ...
                                <div key={id} className="bg-white rounded-lg shadow-md p-4 flex flex-col">
                                    <div className="flex flex-row">
                                        ...
                                        <div className="flex flex-col justify-center sm:ml-4">
                                            ...
                                            <StaticStar count={avgStars[`${student_email}-${language_name}`] || 0} />
                                            <p
                                                className="text-gray-500 hover:cursor-pointer hover:underline w-fit"
                                                onClick={() => {
                                                    localStorage.setItem("mentor_language", language_name);
                                    ...
                                    <div className="flex mt-4 gap-2">
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                HandlePopUp(student_name, student_email, language_name, level, request_id)
                                            }
                                        >
                                            Reject
                                        </button>
